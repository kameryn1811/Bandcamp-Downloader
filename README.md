...
This was created as an interim solution for users experiencing issues with [Otiel's BandcampDownloader](https://github.com/Otiel/BandcampDownloader) (issues resolved as of Nov 30, 2025 - C++ version is now working reliably, see [Otiel's Repo](https://github.com/Otiel/BandcampDownloader) for more information). 
...
* **Dark and Light Mode** - Switch between dark and light themes to match your preference.
...
* **URL Tags** - URLs are automatically converted to colored, interactive tags with hover overlays. Hover to access options: open in browser, view metadata, copy, paste, or delete. Additional Color Schemes available in settings or easily make your own by editing or copying .css files in Color Schemes folder. 
